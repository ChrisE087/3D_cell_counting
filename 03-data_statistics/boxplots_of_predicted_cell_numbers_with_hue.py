...
ax = sns.boxplot(x=predictions1['Absolute Differenz'], y=predictions1['Kultivierungszeitraum'], hue=predictions1['Netz'])
...
ax.set(xlabel=r'$Err^{abs}_{co}$', ylabel='Kultivierungszeitraum')
