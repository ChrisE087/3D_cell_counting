...
y=y*linear_output_scaling_factor
...
if linear_output_scaling_factor == 1:
    print('Number of cells in y_plot: ', np.sum(y_plot))
    plt.imshow(y_plot[:,:,plot_slice])
else:
    print('Number of cells in y_plot: ', np.sum(y_plot/linear_output_scaling_factor))
    plt.imshow(y_plot[:,:,plot_slice]/linear_output_scaling_factor)
