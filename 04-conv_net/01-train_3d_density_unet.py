...
# Dataset Parameters
path_to_trainset = os.path.join('..', '..', '..', 'Datensaetze', 'dataset1_density-maps_fiji', 'train')
path_to_valset = os.path.join('..', '..', '..', 'Datensaetze', 'dataset1_density-maps_fiji', 'val')
path_to_testset = os.path.join('..', '..', '..', 'Datensaetze', 'dataset1_density-maps_fiji', 'test')
plt_hist = False
data_shape = (32, 32, 32)
channels = 1
train_percentage = 1
