...
model_import_path = os.path.join('..', '04-conv_net', 'model_export', 'FINAL', 'dataset_mix', 'segmentations', '2019-08-28_22-40-35_1')
...
# Dataset Parameters
path_to_dataset = os.path.join('..', '..', '..', 'Datensaetze', 'dataset_segmentation-fiji_and_mathematica_filtered')
data_shape = (32, 32, 32)
channels = 1
