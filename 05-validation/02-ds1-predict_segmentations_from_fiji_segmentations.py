...
model_import_path = os.path.join('..', '04-conv_net', 'model_export', 'dataset1', '2019-08-10_11-58-10_1_3_train_samples_fiji_SEGMENTATIONS_crossentropy_256_epochs_more_filters')
