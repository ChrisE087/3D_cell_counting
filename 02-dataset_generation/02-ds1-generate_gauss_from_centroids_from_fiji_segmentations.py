                ...
                for subdir in os.listdir(data_dir):
                    ...
                    if(os.path.isdir(res_dir)):
                        if spheroid_name in subdir:
                            ...
                            seg_file = os.path.join(res_dir, 'centroids_fiji_seg.nrrd')
                            ...
                            nrrd_gauss_centroids_file = os.path.join(res_dir, 'gauss_centroids_fiji_seg.nrrd')
...
with open('gauss_cell_numbers_dataset1_fiji_segmentations_filtered.txt','w') as file:
    for item in table:
