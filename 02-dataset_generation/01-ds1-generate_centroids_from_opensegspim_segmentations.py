                ...
                for subdir in os.listdir(data_dir):
                    ...
                    if(os.path.isdir(res_dir)):
                        if spheroid_name in subdir:
                            ...
                            nrrd_centroids_file = os.path.join(res_dir, 'centroids_opensegspim_seg.nrrd')
...
with open('cell_numbers_dataset1_opensegspim_segmentations_filtered.txt','w') as file:
    for item in table:
